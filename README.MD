...
| Choose a content bundle (or compose your own) | [`docs/bundles/README.md`](docs/bundles/README.md) |
| Tune indexing for a Pi, laptop, or workstation | [`docs/rag-optimization.md`](docs/rag-optimization.md) |
