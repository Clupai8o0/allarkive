...
- Vector DB choice: are we sticking with [TBD — sqlite-vec, lancedb, qdrant?]
- Embedding model: small + fast vs slightly larger + better recall.
...
Every "TBD" above must be resolved before v0.1 ships.